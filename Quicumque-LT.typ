...
#place(
  ...
  scope: "parent",
  float: true,
  heading[Sýmbolum Athanasiánum],
)

*Antíphona.* Glória tibi, Trínitas æquális, una Déitas, et ante ómnia sǽcula, et nunc, et in perpétuum. #text(style: "italic", rgb(gray))[(T.P Allelúia)]
...
Glória Patri, et Fílio, et Spirítui Sancto. #h(2em)
*Sicut erat in princípio, et nunc, et semper, et in sǽcula sæculórum. Amen.*

*Antíphona.* Glória tibi, Trínitas æquális, una Déitas, et ante ómnia sǽcula, et nunc, et in perpétuum. #text(style: "italic", rgb(gray))[(T.P Allelúia)]

Dómine, exáudi oratiónem meam. #h(15em) *Et clamor meus ad te véniat.*

#rubric_red([_Sacerdotes addunt:_])

Dóminus vobíscum.. #h(9em)
*Et cum spíritu tuo.*
